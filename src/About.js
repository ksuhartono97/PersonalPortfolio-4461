        ...
        <Grid>
          ...
          >
            ...
            <Grid.Column width={12}>
              <Container fluid>
                <p>
                  Hey there {this.props.username}, welcome to my portfolio site!
                </p>
                <p>
                  My name is Kristian Suhartono, a third year Computer Science
                  Student in HKUST
                </p>
                <p>
          ...
          <Grid.Row only="mobile" verticalAlign="middle" centered>
            <Grid.Column>
              <Image src={Profpic} size="medium" shape="circular" />
            </Grid.Column>
          </Grid.Row>
